                    ...
                    <div className='w-full max-w-md'>
                        ...
                        >
                            <div className='text-center mb-8'>
                                ...
                                <p className='text-gray-600'>Join our platform and start your job search journey</p>
                            </div>
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    data-gtm-cta='candidate_signup_continue_button'
                                    data-gtm-cta-text='Continue as a Job Seeker'
                                    data-gtm-cta-position='signup_page'
                                    data-gtm-cta-funnel='candidate_signup'
                                    data-gtm-cta-step='1'
                                >
                                    {isLoading ? 'Sending Code...' : 'Continue as a Job Seeker →'}
                                </Button>
                            </form>
