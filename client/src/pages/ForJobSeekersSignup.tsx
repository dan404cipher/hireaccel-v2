                    ...
                    <div className='flex-1 flex flex-col justify-center px-8'>
                        ...
                        <div className='mb-8'>
                            ...
                            <p className='mt-4 max-w-xl text-sm leading-6 text-muted-foreground'>
                                Access your AI-powered job search dashboard and discover opportunities that match your
                                skills. Join hundreds of candidates finding their dream jobs.
                            </p>
                ...
                <div className='w-full max-w-md'>
                    <div className='text-center mb-6'>
                        <div className='flex items-center justify-center space-x-1 mb-3'>
                            ...
                            <span className='text-xs text-purple-500'>Create Account</span>
                        </div>
                        <h1 className='text-xl font-semibold text-gray-900 mb-1.5'>Sign Up as Job Seeker</h1>
                        <p className='text-sm text-gray-600'>Join our platform and start your job search journey</p>
                    </div>
