...
export const SMSOTPVerificationPage: React.FC<SMSOTPVerificationPageProps> = ({
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-center text-gray-600">
                  To complete your account setup and access all features, please add your email and create a password.
                </p>
