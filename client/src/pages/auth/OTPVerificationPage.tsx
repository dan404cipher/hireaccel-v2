...
export const OTPVerificationPage: React.FC<OTPVerificationPageProps> = ({ onVerificationSuccess }) => {
    ...
    useEffect(() => {
        if (!email) {
            navigate('/register/hr', { replace: true });
        }
    }, [email, navigate]);
    ...
    const handleVerifyOTP = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(error.message || error.detail || 'Invalid or expired OTP. Please try again.');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const handleResendOTP = async () => {
        ...
        try {
            ...
            setError(error.message || error.detail || 'Failed to resend OTP. Please try again.');
        } finally {
    ...
    const handleBackToSignup = () => {
        const signupPath = userType === 'candidate' ? '/register/candidate' : '/register/hr';
