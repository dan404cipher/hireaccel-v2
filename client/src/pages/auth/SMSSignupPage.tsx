      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Join our platform in seconds with your mobile number
          </p>
        </div>
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription>
              Get started with just your mobile number
            </CardDescription>
          </CardHeader>

          <CardContent className="space-y-6">
            <Tabs value={formData.role} onValueChange={(value) => handleInputChange('role', value as 'hr' | 'candidate')}>
