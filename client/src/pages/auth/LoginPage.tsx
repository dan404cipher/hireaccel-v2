          ...
          <div className="flex-1 flex flex-col justify-center px-8">
            ...
            <div className="mb-8">
              ...
              <p className="mt-4 max-w-xl text-sm leading-6 text-muted-foreground">
                Access your AI-powered recruitment dashboard and continue
                connecting talent with opportunities. Join hundreds of HR
            ...
            <CardContent className="p-0">
              ...
              <div className="mt-8 bg-gradient-to-r from-blue-50 to-green-50 p-4 rounded-lg border border-blue-100">
                <p className="text-sm text-gray-700 text-center">
                  <strong>Welcome to HireAccel!</strong> Access your dashboard
                  and continue your hiring journey with powerful recruitment
                  tools.
                </p>
              </div>
            </CardContent>
