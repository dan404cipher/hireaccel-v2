...
const UnifiedSignupForm = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await apiClient.registerUnified({
        ...
        designation:
          role === "hr" ? designation.trim() || undefined : undefined,
        utmData: utmParams,
      });
  ...
  const renderHeader = () => {
    ...
    const dotColorClass =
      config.headerColor === "purple" ? "bg-purple-500" : "bg-blue-500";
    const textColorClass =
      config.headerColor === "purple" ? "text-purple-500" : "text-blue-500";
    ...
    <div className={className}>
      ...
      >
        <div className="space-y-2">
          ...
          />
          {nameError && (
            <p className="text-xs sm:text-sm text-red-500">{nameError}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="w-full">
            <Input
              ...
              onBlur={() => {
                ...
                if (
                  nationalDigits.split("").every((d) => d === nationalDigits[0])
                ) {
                  setPhoneError("Phone number cannot have all same digits");
                  return;
                }
          ...
          {phoneError && (
            <p className="text-xs sm:text-sm text-red-500">{phoneError}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            type="email"
            placeholder={
              role === "hr" ? "jane@company.com" : "john@example.com"
            }
            value={email}
