...
export function CompetitorComparison() {
    ...
    return (
        <>
            <section
                className='relative min-h-screen flex flex-col justify-center items-center py-10 bg-gray-50/50 mx-auto'
                style={{
                ...
                <div className='container mx-auto px-5 md:px-4 py-8 md:py-10 relative z-10 h-full'>
                    <div className='text-center mb-16'>
                        ...
                        <p className='text-xl text-white max-w-3xl mx-auto leading-relaxed'>
                            While leading Indian recruitment platforms charge lakhs annually for basic features,
                            HireAccel delivers enterprise-grade recruitment solutions completely free. See the
                            difference and discover why smart HR teams across India are making the switch.
                        </p>
                    </div>
                        ...
                        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
                            {competitors.map((competitor, index) => (
                                <div key={competitor.name} className='relative'>
                                    <Card
                                        className={`p-6 h-full relative overflow-visible ${
                                            competitor.isOurs
                                                ...
                                                <div key={featureIndex} className='flex items-start space-x-2'>
                                                    ...
                                                    <span
                                                        className={`text-sm text-gray-700 ${
                                                            featureIndex === 0 ? 'font-bold !font-bold' : ''
                                                        }`}
                                                        style={{
                                        ...
                                        <div className='mt-auto'>
                                            {competitor.isOurs ? (
                                                <Button
                                                    ...
                                                    data-gtm-cta='home_competitor_comparison_get_started_button'
                                                    data-gtm-cta-text='Get Started Free'
                                                    data-gtm-cta-position='competitor_comparison'
            ...
            <section
                className='relative min-h-screen flex flex-col justify-center items-center py-10 bg-gray-50/50'
                style={{
                ...
                <div className='container mx-auto px-5 md:px-4 py-8 md:py-10 relative z-10 h-full'>
                    ...
                    <div className='mb-16'>
                        <div className='text-center mb-10'>
                            ...
                            <p className='text-lg text-white'>Detailed breakdown of features and capabilities</p>
                        </div>
                                    ...
                                    <table className='w-full'>
                                        ...
                                        <tbody>
                                            {featureComparison.map((row, index) => (
                                                ...
                                                >
                                                    <td
                                                        className={`p-3 md:p-4 font-medium text-white text-sm md:text-base ${
                                                            index === 0 ? 'font-bold' : ''
                                                        }`}
                                                    >
                                                        {row.feature}
                                                    ...
                                                    >
                                                        <div className='flex items-center justify-center space-x-1 md:space-x-2'>
                                                            ...
                                                            <span
                                                                className={`text-green-400 shadow shadow-green-md font-medium text-sm md:text-base ${
                                                                    index === 0 ? 'font-bold' : ''
                                                                }`}
                                                            >
                                                                {row.hireAccel}
                                                    ...
                                                    <td
                                                        className={`p-3 md:p-4 text-center text-white text-sm md:text-base ${
                                                            index === 0 ? 'font-bold' : ''
                                                        }`}
                                                    >
                                                        {row.competitor1}
            ...
            >
                ...
                <div className='container mx-auto px-5 md:px-4 py-8 md:py-10 relative z-10 h-full'>
                    ...
                    <div className='bg-gray-900 rounded-2xl p-8 md:p-12 border border-green-200/50'>
                        <div className='text-center'>
                            ...
                            <p className='text-lg text-white mb-8 max-w-2xl mx-auto'>
                                While major Indian recruitment platforms charge premium prices for basic features,
                                HireAccel provides everything you need completely free. That's real money back in your
                                budget for what matters most - growing your team and business.
                            </p>
                            ...
                            <Button
                                ...
                                onClick={() => navigate('/register/hr')}
                                data-gtm-cta='home_competitor_start_saving_button'
                                data-gtm-cta-text="Start Saving Today - It's Free!"
                                data-gtm-cta-position='competitor_comparison_bottom'
                                data-gtm-cta-destination='/register/hr'
                                data-gtm-page='home'
                            >
