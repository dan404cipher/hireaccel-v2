            ...
            <div className='relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
                <div className='animate-fade-in'>
                    ...
                    <p className='text-xl text-blue-100 mb-12 max-w-2xl mx-auto leading-relaxed'>
                        Join thousands of HR professionals and job seekers using our permanently free platform. No
                        hidden costs, no subscriptions, no limits - just powerful AI recruitment tools forever.
                    </p>
                </div>
            ...
            Learn More
                ...
                <div className='mb-8 animate-scale-in'>
                    <div className='inline-flex items-center justify-center gap-2 px-6 py-3 mb-6 bg-gradient-to-r from-yellow-400/20 via-green-400/20 to-blue-400/20 backdrop-blur-md rounded-full border-2 border-white/30'>
                        ...
                        <span className='text-white text-lg font-bold tracking-wide'>Sign Up - It's Free Forever</span>
                        <Sparkles className='h-5 w-5 text-yellow-400 animate-pulse' />
                    </div>
                    ...
                    <div className='flex flex-col sm:flex-row gap-6 justify-center'>
                        <Button
                            ...
                            data-gtm-cta='home_cta_for_hr_button'
                            data-gtm-cta-text='For HR'
                            data-gtm-cta-position='cta_section'
                        ...
                        <Button
                            ...
                            data-gtm-cta='home_cta_for_jobseekers_button'
                            data-gtm-cta-text='For Job Seekers'
                            data-gtm-cta-position='cta_section'
