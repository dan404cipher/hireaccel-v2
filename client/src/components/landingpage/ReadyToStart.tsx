        ...
        >
            ...
            <div className='container mx-auto px-4 relative z-10'>
                <div className='text-left bg-transparent rounded-2xl p-12 text-white animate-scale-in'>
                    <h3 className='text-2xl sm:text-2xl md:text-4xl lg:text-6xl xl:text-7xl 2xl:text-7xl font-bold mb-4'>
                    ...
                    <div className='flex flex-col sm:flex-row gap-4 justify-start'>
                        <Button
                            ...
                            data-gtm-cta='home_ready_start_hiring_button'
                            data-gtm-cta-text='Start Hiring'
                            data-gtm-cta-position='ready_to_start_section'
                        ...
                        <Button
                            ...
                            data-gtm-cta='home_ready_find_jobs_button'
