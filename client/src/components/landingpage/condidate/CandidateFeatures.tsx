                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-center'>
                            ...
                            <div className='lg:col-span-7'>
                                <h1 className='text-2xl sm:text-2xl md:text-4xl lg:text-6xl font-bold mb-6 leading-tight'>
                                    <span className='text-white bg-clip-text text-transparent'>Skip the job hunt.</span>
                                    <br />
                                    <span className='text-white'>Let opportunities find you.</span>
                                </h1>
                                ...
                                <div className='text-xs sm:text-md md:text-lg lg:text-xl xl-text-xl 2xl:text-xl text-white/80 mb-8 leading-relaxed'>
                                    ...
                                    <p>
                                        Our expert agents work 24/7 to match your profile with hiring teams. You'll
                                        receive{' '}
                                ...
                                >
                                    <div className=' hidden  gap-4 sm:items-start'>
                                        ...
                                        <div className='flex-1 w-full'>
                                            ...
                                            {phoneError && (
                                                <p className='text-red-400 text-xs sm:text-sm mt-1'>{phoneError}</p>
                                            )}
                                        </div>
                    ...
                    <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                        ...
                        <div className='text-center mb-20'>
                            ...
                            <p className='text-lg md:text-2xl text-white/80 max-w-4xl mx-auto leading-relaxed'>
                                Simple 4-step process powered by AI to get you directly connected with hiring teams
                                looking for your exact skills and experience.
                            </p>
                        </div>
                        ...
                        <div className='text-center mt-10'>
                            <div className='bg-gray-900/10 rounded-3xl p-8 border border-gray-200/50 backdrop-blur-sm max-w-4xl mx-auto'>
                                <p className='text-sm md:text-md lg:text-lg text-white mb-6 leading-relaxed'>
                                    We log every submission with agent notes and timestamps — your activity stays
                                    private until you approve any introduction.
                    ...
                    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                        ...
                        <div className='text-center mb-10'>
                            <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-4'>
                                <span className='text-white bg-clip-text text-transparent'>Everything You Need</span>
                                <br />
                            ...
                            <p className='text-sm sm:text-md md:text-lg lg:text-xl text-white/80 max-w-4xl mx-auto leading-relaxed'>
                                Built specifically for job seekers who want complete control over their career
                                opportunities
                            </p>
                        </div>
            ...
            >
                ...
                <div className='container mx-auto px-5 md:px-4 py-8 md:py-10 relative z-10 h-full'>
                    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                        ...
                        <div className='text-center mb-10'>
                            <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-4'>
                                <span className='text-white bg-clip-text text-transparent'>Real Results from</span>
                                <br />
                            ...
                            <div className='bg-gray-900/80 rounded-3xl p-10 border border-blue-200/50 shadow-lg backdrop-blur-sm max-w-4xl mx-auto'>
                                <div className='flex flex-col items-center space-y-6'>
                                    ...
                                    <p className='text-xs sm:text-sm md:text-md lg:text-lg text-white max-w-2xl mx-auto leading-relaxed'>
                                        Be the next professional to land your dream job. It takes just 2 minutes to get
                                        started.
                                    </p>
            ...
            >
                ...
                <div className='container mx-auto px-5 md:px-4 py-8 md:py-10 relative z-10 h-full'>
                    <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
                        ...
                        <div className='text-center mb-10'>
                            <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-4'>
                                <span className='text-white bg-clip-text text-transparent'>Transform Your</span>
                                <br />
                            ...
                            <p className='text-sm sm:text-md md:text-lg lg:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed'>
                                Join thousands of professionals who've already discovered a smarter way to find their
                                dream job
                            </p>
                        </div>
            ...
            >
                ...
                <div className='container mx-auto px-5 md:px-4 py-8 md:py-10 relative z-10 h-full'>
                    <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
                        ...
                        <div className='text-center mb-10'>
                            <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-4'>
                                <span className='text-white bg-clip-text text-transparent'>Your Questions</span>
                                <br />
                            ...
                            <p className='text-sm sm:text-md lg:text-xl md:text-lg text-white/80 max-w-4xl mx-auto leading-relaxed'>
                                Everything you need to know about getting started and making the most of your career
                                opportunities
                            </p>
                        </div>
                                ...
                                <div className='bg-white/40 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/30 max-w-3xl mx-auto'>
                                    ...
                                    <p className='text-sm text-gray-600 leading-relaxed'>
                                        ...
                                        <span className='font-semibold text-gray-800'>
                                            We will never share your contact info without explicit consent.
                                        </span>
                                    </p>
                                </div>
                            </div>
