...
const features = [
  {
    ...
    description:
      "Upload Word/PDF; we extract education, experience & skills so you don't type.",
  ...
  },
  {
    ...
    description:
      "Quick tips for first call, document checklist, and calendar link suggestion.",
    micro:
      "Get a short message with interview tips when a company expresses interest.",
    color: "orange",
  },
];
...
const testimonials = [
  {
    quote:
      "I uploaded my CV and got two interview invites in 72 hours — simple and private.",
    author: "Asha R.",
    location: "Chennai",
...
const benefits = [
  {
    ...
    description:
      "Our agents work with hiring teams — we surface you where fits exist.",
    color: "blue",
  },
  {
    icon: Clock,
    title: "Time-saver",
    description:
      "One profile = multiple opportunities. Spend 2 minutes now to get continuous exposure.",
    color: "red",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "Agents include context & short notes with each submission so recruiters see a quick fit summary.",
    color: "yellow",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Free for candidates during launch. Agents submit your profile to hiring teams at no charge.",
  },
  {
    question: "Will companies contact me directly?",
    answer:
      "No — companies receive profiles only when our agents submit them and you have consented. Your personal contact is hidden until you approve an intro.",
  },
  {
    question: "How long until I hear back?",
    answer:
      "Agents aim to submit first matches within 48 hours of job posting or profile readiness. Response time from companies varies.",
  },
  {
    question: "What documents are required?",
    answer:
      "CV/Resume (PDF/DOCX) — optional photo; education and experience. The parser extracts the rest.",
  },
  {
    question: "Can I apply to jobs directly?",
    answer:
      "Initially, matching is agent-driven. We'll add in-product 'apply' flows later; for now agents do submissions to hiring teams.",
  },
];
...
export function JobCandidates() {
  ...
  const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Remove numbers and special characters (only allow letters, spaces, hyphens, and apostrophes)
  ...
  const handlePhoneChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Get only digits (the visual prefix +91 is not part of the input value)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7">
                ...
                <div className="text-xs sm:text-md md:text-lg lg:text-xl xl-text-xl 2xl:text-xl text-white/80 mb-8 leading-relaxed">
                  ...
                  <p>
                    Our expert agents work 24/7 to match your profile with
                    hiring teams. You'll receive{" "}
                    <span className="text-blue-300 drop-shadow-[0_0_8px_#00fff7]">
                      interview invites directly
                    </span>{" "}
                    — no more applications, no more waiting.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 relative">
                ...
                {/* Dashboard Mockup */}
                <div className="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 shadow-xl">
                ...
                <div className="mt-4 bg-gradient-to-r from-gray-900/50 to-gray-500/10 rounded-xl p-4 border border-blue-100/50">
                  ...
                  <p className="text-sm text-white/90 mt-2">
                    Your profile submitted to senior developer role at FinTech
                    startup
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {quickBenefits.map((benefit, index) => (
                <div key={index} className="flex items-center space-x-3">
                  <div
                    className={`w-12 h-12 bg-${benefit.color}-500 rounded-xl flex items-center justify-center flex-shrink-0`}
                  >
            ...
            <div className="text-center mt-8">
              <p className="text-white/80 font-medium">
                No fees. No hassle. Just one profile.
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        id="how-it-works"
        ref={stepsRef}
        className="relative  min-h-screen flex felx-col items-center py-10 bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden"
        style={{
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-lg md:text-2xl text-white/80 max-w-4xl mx-auto leading-relaxed">
                Simple 4-step process powered by AI to get you directly
                connected with hiring teams looking for your exact skills and
                experience.
              </p>
            </div>
                ...
                {howItWorksSteps.map((step, index) => (
                  <div key={index} className="relative group">
                    ...
                    <div className="relative bg-gradient-to-br from-gray-900/30 to-gray-500/30 rounded-3xl p-8 border-2 border-white/50 shadow-xl hover:shadow-2xl transition-shadow duration-200 backdrop-blur-sm overflow-hidden h-full">
                      ...
                      <div
                        className={`absolute -top-4 -right-4 w-16 h-16 bg-${step.color}-500 rounded-full shadow-lg flex items-center justify-center border-4 border-white z-10`}
                      >
                      ...
                      <div className="flex items-center justify-center mb-8">
                        <div className="relative">
                          <div
                            className={`w-20 h-20 bg-${step.color}-500 rounded-3xl flex items-center justify-center shadow-lg`}
                          >
            ...
            <div className="text-center mt-10">
              <div className="bg-gray-900/10 rounded-3xl p-8 border border-gray-200/50 backdrop-blur-sm max-w-4xl mx-auto">
                <p className="text-sm md:text-md lg:text-lg text-white mb-6 leading-relaxed">
                  We log every submission with agent notes and timestamps — your
                  activity stays private until you approve any introduction.
                  <span className="font-semibold text-blue-300 drop-shadow-[0_0_8px_#00fff7]">
                    {" "}
      ...
      <section
        id="features"
        ref={featuresRef}
        className="relative min-h-screen flex flex-col justify-center items-center py-10 bg-white"
        style={{
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-sm sm:text-md md:text-lg lg:text-xl text-white/80 max-w-4xl mx-auto leading-relaxed">
                Built specifically for job seekers who want complete control
                    ...
                    <Card className="h-full bg-gray-900/80 border border-gray-200/50 rounded-3xl transition-all duration-300 shadow-lg hover:shadow-2xl overflow-hidden">
                      <CardContent className="p-6">
                        ...
                        <div className="flex items-center justify-center mb-4">
                          <div
                            className={`w-16 h-16 bg-${feature.color}-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                          >
            ...
            {/* Bottom Stats */}
            <div className="bg-gray-900/50 rounded-3xl p-8 border border-purple-200/50 shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                ...
                <div className="space-y-2">
                  <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-pink-600">
                    48hrs
                  </div>
      ...
      <section
        id="testimonials"
        ref={testimonialsRef}
        className="relative min-h-screen flex flex-col justify-center items-center py-10 bg-gradient-to-br from-white via-gray-50/30 to-white"
        style={{
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-md md:text-lg lg:text-xl text-white/80 max-w-4xl mx-auto leading-relaxed">
                Join professionals who've already transformed their job search
                with our platform
              </p>
            </div>
              ...
              <div className="bg-gradient-to-r from-gray-900/80 via-gray-800/50 to-gray-50/10 rounded-3xl p-8 border border-blue-200/30 shadow-lg backdrop-blur-sm">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="text-white font-medium">
                      Matches sent this month
                    </div>
                    <div className="text-sm text-white">
                      Direct to hiring teams
                    </div>
                  </div>
              ...
              <div className="text-center">
                ...
                <div className="bg-gradient-to-r from-gray-900/80 via-gray-800/50 to-gray-50/10 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/50 shadow-lg">
                  ...
                  <p className="text-sm text-white mt-4">
                    Representative companies in our network
                  </p>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  role: "Software Developer",
                  image:
                    "https://images.unsplash.com/photo-1667382137969-a11fd256717d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBJbmRpYW4lMjB3b21hbiUyMHNtaWxpbmclMjBwb3J0cmFpdHxlbnwxfHx8fDE3NTcwNjQwODZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
                  date: "Dec 28, 2024",
                  time: "2:30 PM",
                },
                {
                  quote:
                    "The parser filled most fields for me; agents handled the outreach.",
                  author: "Rohit S.",
                  location: "Bengaluru",
                  role: "QA Engineer",
                  image:
                    "https://images.unsplash.com/photo-1681165232934-c09dfa5ee694?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjBJbmRpYW4lMjBtYW4lMjBzb2Z0d2FyZSUyMGRldmVsb3BlciUyMHBvcnRyYWl0fGVufDF8fHx8MTc1NzA2NDA5MHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
                  date: "Dec 27, 2024",
                  time: "11:15 AM",
                },
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="mb-4">
                        <div className="flex items-start space-x-2 mb-4">
                          <div className="text-white text-lg sm:text-xl md:text-2xl lg:text-4xl leading-none">
                            "
                          </div>
                          <blockquote className="text-md md:text-md lg:text-lg text-white leading-relaxed font-medium italic">
                            {testimonial.quote}
                          </blockquote>
                          <div className="text-white text-4xl leading-none self-end">
                            "
                          </div>
                        </div>
                      </div>
              ...
              <div className="bg-gray-900/80 rounded-3xl p-10 border border-blue-200/50 shadow-lg backdrop-blur-sm max-w-4xl mx-auto">
                <div className="flex flex-col items-center space-y-6">
                  ...
                  <p className="text-xs sm:text-sm md:text-md lg:text-lg text-white max-w-2xl mx-auto leading-relaxed">
                    Be the next professional to land your dream job. It takes
      ...
      <section
        id="benefits"
        ref={deepBenefitsRef}
        className="relative min-h-screen flex flex-col items-center py-10 bg-gray-50/50"
        style={{
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-sm sm:text-md md:text-lg lg:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                Join thousands of professionals who've already discovered a
                smarter way to find their dream job
              </p>
            </div>
              ...
              {benefits.map((benefit, index) => (
                ...
                >
                  ...
                  <div className="flex-shrink-0">
                    <div
                      className={`w-16 h-16 bg-${benefit.color}-500 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
      ...
      <section
        id="faq"
        ref={faqRef}
        className="relative min-h-screen flex flex-col items-center bg-gradient-to-br pt-10 from-blue-50/50 via-purple-50/30 to-blue-50/50"
        style={{
          backgroundImage: `url(${heroBackground})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-10">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-4">
                ...
                <br />
                <span className="text-white/90">Answered</span>
              </h2>
              ...
              <div className="text-center">
                <div className="bg-white/40 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/30 max-w-3xl mx-auto">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    By creating a profile you consent to our{" "}
                    ...
                    <span className="font-semibold text-gray-800">
                      We will never share your contact info without explicit
                      consent.
                    </span>
                  </p>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div>
            ...
            <p className="text-sm sm:text-md md:text-lg lg:text-xl mb-8 opacity-90">
              Join 1,200+ candidates who trust HireAccel to find them
              opportunities
            </p>
            <Button
              size="lg"
